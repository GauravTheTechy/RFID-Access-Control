...
void openDoor() {
  ...
  // Increasing speed while opening
  for (int i = 0; i <= 100; i++) {
    Servo1.write(i);
    delay(10);  // Decreased delay for faster opening
  }

  delay(5000);  // Delay after fully opened

  // Decreasing speed while closing
  for (int i = 100; i >= 0; i--) {
    Servo1.write(i);
    delay(10);  // Decreased delay for faster closure
  }

  delay(5000);  // Delay after fully closed
}
